...
export function MessageInput({ onSubmit }) {
  ...
  return (
    <div className="popup-input" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <form className="popup-form" onSubmit={handleSubmit} style={{ flex: 1, overflowY: 'auto', maxHeight: '60vh' }}>
